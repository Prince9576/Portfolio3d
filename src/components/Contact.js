...
const Form = ({ setSnackbar }) => {
  ...
  const isFormValid = () => {
    ...
    const emailValid =
      formData.email.trim() && validateEmail(formData.email) && formData.email.length <= 100;
    const messageValid =
      formData.message.trim().length >= 10 && formData.message.trim().length <= 1000;
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      try {
        ...
        const response = await fetch('https://formsubmit.co/princek9576@gmail.com', {
          method: 'POST',
          headers: {
        ...
        setSnackbar({
          show: true,
          message: 'Email client opened! Please send the message through your email application.',
          type: 'error',
        });
      }
  ...
  if (showSuccess) {
    return (
      <div className='gradient-border-inner text-center'>
        ...
        <p style={{ color: '#9ca3af', fontSize: '0.875rem' }}>We'll get back to you soon.</p>
        <button
          onClick={handleReset}
          style={{
            marginTop: '1rem',
  ...
  return (
    <div className='gradient-border-inner'>
      <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
        ...
        <p style={{ color: '#9ca3af', fontSize: '0.875rem' }}>We'd love to hear from you</p>
      </div>
      ...
      >
        <div style={formRowStyle}>
          ...
          <input
            ...
            style={{
              ...
              border: `1px solid ${
                errors.name && touched.name ? '#ef4444' : 'rgba(147, 51, 234, 0.5)'
              }`,
        ...
        <div style={formRowStyle}>
          ...
          <input
            ...
            style={{
              ...
              borderRadius: '0.75rem',
              border: `1px solid ${
                errors.email && touched.email ? '#ef4444' : 'rgba(147, 51, 234, 0.5)'
              }`,
              background: 'rgba(88, 28, 135, 0.3)',
              color: 'white',
              fontSize: '1rem',
        ...
        <div style={formRowStyle}>
          ...
          <textarea
            ...
            style={{
              ...
              borderRadius: '0.75rem',
              border: `1px solid ${
                errors.message && touched.message ? '#ef4444' : 'rgba(147, 51, 234, 0.5)'
              }`,
              background: 'rgba(88, 28, 135, 0.3)',
              color: 'white',
              fontSize: '1rem',
        ...
        <button
          ...
          style={{
            ...
            transition: 'all 0.3s',
            boxShadow:
              isFormValid() && !isSubmitting ? '0 8px 30px rgba(247, 147, 30, 0.4)' : 'none',
          }}
          onMouseOver={(e) => {
